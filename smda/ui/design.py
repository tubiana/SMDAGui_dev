...
class Ui_Design(object):
    def setupUi(self, SMDA):
        ...
        self.toolButtonInputTopologyButton.setObjectName("toolButtonInputTopologyButton")
        ...
        self.toolButtonOutputTrajectoryButton.setObjectName("toolButtonOutputTrajectoryButton")
        ...
        self.toolButtonOutputTopologyButton.setObjectName("toolButtonOutputTopologyButton")
        ...
        self.label_outputFolder.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        ...
        self.toolButtonOutputFiguresButton.setObjectName("toolButtonOutputFiguresButton")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.treeWidgetChoosenAnalysis.sizePolicy().hasHeightForWidth())
        ...
        self.treeWidgetAnalysisAvailable.setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
        ...
        sizePolicy.setHeightForWidth(self.tabWidgetParametersResults.sizePolicy().hasHeightForWidth())
        ...
        self.checkBoxHasLigand.toggled['bool'].connect(self.lineEditLigandName.setEnabled)
    ...
    def retranslateUi(self, SMDA):
        ...
        self.checkBoxReplicas.setToolTip(_translate("Design", "If several trajectories are given, are they replicas (same topology ?)"))
        ...
        self.label_39.setToolTip(_translate("Design", "<html><head/><body><p>Remove selected atoms from the initial trajectory. </p><p><span style=\" font-weight:600;\">Help to reduce memory</span></p></body></html>"))
        self.label_39.setText(_translate("Design", "Stripping"))
        self.checkBoxRemoveWater.setToolTip(_translate("Design", "<html><head/><body><p>Remove solvent/water if checked.</p><p><span style=\" font-weight:600;\">For big trajectory please check this! especially if you don\'t mind the solvent.</span></p></body></html>"))
        self.checkBoxRemoveWater.setText(_translate("Design", "Remove water?"))
        self.checkBoxHasLigand.setToolTip(_translate("Design", "Click if you want automatic ligand analysis"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Design", "Input"))
        self.label_34.setToolTip(_translate("Design", "output trajectory"))
        self.label_34.setText(_translate("Design", "Trajectory"))
        self.lineEditOutputTrajectoryPath.setToolTip(_translate("Design", "output trajectory"))
        ...
        self.label_41.setToolTip(_translate("Design", "<html><head/><body><p>Remove selected atoms from the initial trajectory. </p><p><span style=\" font-weight:600;\">Help to reduce memory</span></p></body></html>"))
        self.label_41.setText(_translate("Design", "Stripping"))
        self.lineEditOutputStripping.setToolTip(_translate("Design", "<html><head/><body><p><span style=\" font-weight:600;\">OPTIONAL</span> : if you want to strip some part of the dynamic.</p></body></html>"))
        self.label_36.setToolTip(_translate("Design", "output topology"))
        self.label_36.setText(_translate("Design", "Topology"))
        self.lineEditOutputTopologyPath.setToolTip(_translate("Design", "output topology"))
        ...
        self.label_outputFolder.setToolTip(_translate("Design", "<html><head/><body><p>Output folder (for figures). Per default it\'s the name of the topology</p></body></html>"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Design", "Output"))
        ...
        self.toolButtonRemoveAnalysis.setToolTip(_translate("Design", "Remove an analysis"))
        ...
        self.treeWidgetAnalysisAvailable.headerItem().setText(0, _translate("Design", "Analyses"))
        self.labelDescription.setText(_translate("Design", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600;\">Welcome in SMDAgui!</span></p><p><span style=\" text-decoration: underline;\">To begin</span> : </p><p>1. Fill <span style=\" font-weight:600;\">INPUT</span> and/or <span style=\" font-weight:600;\">OUTPUT</span> parameters</p><p>2. Choose an Analysis from the <span style=\" font-style:italic;\">Analysis menu</span> (on the left)</p><p>3. Add it on the <span style=\" font-style:italic;\">Choosen Analysis list</span> (upside) by clicking on the <span style=\" font-style:italic;\">righ arrow</span></p><p>4. Fill parameters</p><p>5. Do it for each analysis you want</p><p>6. Click on <span style=\" font-weight:600;\">RUN!</span></p><p><br/></p></body></html>"))
